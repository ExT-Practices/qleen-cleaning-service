...
const DATA = {
  home: [
    ...
    {
      title: "Deep Cleaning",
      desc: "Includes baseboards, behind appliances, and deep sanitization",
      price: "$160",
      note: "(up to 2 bed/1 bath)",
    },
    {
      title: "Move in/out Cleaning",
      desc: "Empty home, deep clean of all rooms, bathrooms, and kitchen",
      price: "$180 – $250",
    },
    {
      title: "Post Construction Cleaning",
      desc: "Debris removal, fine dust vacuuming, detail cleaning of all surfaces",
      price: "$200 – $300",
    },
  ],
  office: [
    {
      ...
      desc: "Daily or weekly desk wiping, trash emptying, and floor care",
      price: "$190",
      note: "(eco-friendly)",
    },
    {
      title: "Industrial Sanitation",
      desc: "Heavy-duty commercial sanitation, deep scrubbing, and fogging",
      price: "$300 – $450",
    },
    {
      title: "Small Maintenance",
      desc: "Light touch-ups, restroom restock, and surface wipe downs",
      price: "$200 – $250",
    },
    {
      title: "Deep Cleaning",
      desc: "Comprehensive office overhaul, carpet extraction, high dusting",
      price: "$400 – $500",
    },
  ],
  addon: [
    {
      ...
      desc: "Interior & exterior glass, tracks, frames, and screen wiping",
      price: "$30",
      note: "(per window)",
    },
    {
      title: "Balcony/Terrace Cleaning",
      desc: "Pressure wash or scrub balcony floors, railings, and patio furniture",
      price: "$90 – $120",
    },
    {
      title: "Ironing Clothes",
      desc: "Professional clothing pressing, delicate fabric care, and folding",
      price: "$50",
      note: "(per batch)",
    },
    {
      title: "Steam Cleaning",
      desc: "Deep steam sanitization for upholstery, mattresses, and carpets",
      price: "$80 – $110",
    },
  ],
};
